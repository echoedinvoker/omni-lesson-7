...
class Defect_detectionExtension(omni.ext.IExt):
    # ext_id is current extension id. It can be used with extension manager to query additional information, like where
    # this extension is located on filesystem.
    def on_startup(self, ext_id):
        print("[defect_detection] defect_detection startup")
        manager = omni.kit.app.get_app().get_extension_manager()
        extension_data_path = os.path.join(manager.get_extension_path_by_module("defect_detection"), "data")

        self._window = ui.Window("Defect Detection Window", width=300, height=300)
    ...
    def on_shutdown(self):
        print("[defect_detection] defect_detection shutdown")
